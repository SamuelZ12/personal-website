...
export const Icons = {
    ...
    aws: (props: LucideProps) => (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path d="M7.31 9.06l1.12 2.43A127 127 0 0 0 6.35 13L8 15.5M8.17 15.34c-.51.41-1.1.83-1.74 1.23-.17.12-.37.18-.57.18-.28 0-.57-.11-.77-.32l-1.2-1.25a.97.97 0 0 1-.22-1.09c.13-.32.4-.54.73-.59l1.97-.22M20.71 12.2l-1.83-6.62c-.09-.34-.39-.58-.74-.58h-3.82c-.35 0-.65.24-.74.58l-1.83 6.62c-.11.39.19.78.59.78h1.64c.35 0 .65-.24.74-.58l.23-.83h2.56l.23.83c.09.34.39.58.74.58h1.64c.4 0 .7-.39.59-.78M10.72 17.97l-.17.17c-1.79 1.79-4.69 1.79-6.48 0-1.79-1.79-1.79-4.69 0-6.48l.17-.17M16.5 13.29l.17.17c1.79 1.79 1.79 4.69 0 6.48-1.79 1.79-4.69 1.79-6.48 0l-.17-.17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    ),
